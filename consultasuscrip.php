...
<tr>
<td><?php echo $row['id_suscripcion']; ?></td>
<td><?php echo $row['nombre']; ?></td>
<td><?php echo $row['telefono']; ?></td>
<td><?php echo $row['suscripcion']; ?></td>

<td>
   <a type="submit" class="btn btn-outline-secondary" href="formulario_modificarsuscrip.php?id_suscripcion=<?php echo $row['id_suscripcion'];?>">
    <img src="https://cdn5.dibujos.net/dibujos/pintados/201125/f2db30b527a16bfea022e7c6e9dcb93f.png"width="50px" height="50px">
    
  </a>
</td>
<td>
<a type="submit" class="btn btn-outline-danger" href="eliminarsuscrip.php?id_suscripcion=<?php echo $row['id_suscripcion'];?>">
...
?>
<a type="submit" class="btn btn-outline-danger" href="agregarsuscrip.html">
Alta 
</a>
