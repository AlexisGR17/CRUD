...
$query="SELECT * FROM remitente WHERE id_remitente='$id'";
...
?>
  ...
  <div class="row">
    <form class="col s12" method="POST" action="modificaremitente.php?id_remitente=<?php echo $row['id_remitente']; ?>"method="POST" enctype="multipart/form-data">
      <div class="row">
      ...
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">codigo postal</i>
       ...
       <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">Calle o Avenida </i>
