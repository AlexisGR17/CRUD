...
<td><?php echo $row['redes_sociales']; ?></td>

<td>
 <a type="submit" class="btn btn-outline-secondary" href="formulario_modificarc.php?id_contacto=<?php echo $row['id_contacto'];?>">
    <img src="https://cdn5.dibujos.net/dibujos/pintados/201125/f2db30b527a16bfea022e7c6e9dcb93f.png"width="50px" height="50px">
    
  </a>
</td>
<td>
<a type="submit" class="btn btn-outline-danger" href="eliminarcontacto.php?id_contacto=<?php echo $row['id_contacto'];?>">
...
?>
<a type="submit" class="btn btn-outline-danger" href="agregarcontacto.html">
