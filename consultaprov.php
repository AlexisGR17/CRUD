...
<td>
  <a type="submit" class="btn btn-outline-secondary" href="formulario_modificarprov.php?id_provedor=<?php echo $row['id_provedor'];?>">
    <img src="https://cdn5.dibujos.net/dibujos/pintados/201125/f2db30b527a16bfea022e7c6e9dcb93f.png"width="50px" height="50px">
    
  </a>
</td>
<td>
  <a type="submit" class="btn btn-outline-danger" href="eliminarprov.php?id_provedor=<?php echo $row['id_provedor'];?>">
...
?>
  <a type="submit" class="btn btn-outline-danger" href="agregarprov.html">
