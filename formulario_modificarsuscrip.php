...
$query="SELECT * FROM suscripcion WHERE id_suscripcion='$id'";
...
?>
  ...
  <div class="row">
    <form class="col s12" method="POST" action="modificarsuscrip.php?id_suscripcion=<?php echo $row['id_suscripcion']; ?>"method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">Nombre del servicio:</i>
      ...
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">Descripcion de la suscripcion:</i>
       ...
       <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">Tipo de suscripcion</i>
          <input class="form-control" REQUIRED name="suscripcion" type="text"value="<?php echo $row['suscripcion'];?>" class="validate" id="suscripcion">
        </div>
      </div>
