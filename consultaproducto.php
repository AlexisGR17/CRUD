...
<td>
   <a type="submit" class="btn btn-outline-secondary" href="formulario_modificarproducto.php?id_producto=<?php echo $row['id_producto'];?>">
    <img src="https://cdn5.dibujos.net/dibujos/pintados/201125/f2db30b527a16bfea022e7c6e9dcb93f.png"width="50px" height="50px">
    
  </a>
</td>
<td>
<a type="submit" class="btn btn-outline-danger" href="eliminarproducto.php?id_producto=<?php echo $row['id_producto'];?>">
...
?>
<a type="submit" class="btn btn-outline-danger" href="agregarproducto.html">
