...
?>
  ...
  <div class="row">
    <form class="col s12" method="POST" action="modificarcat.php?id_categoria=<?php echo $row['id_categoria']; ?>"method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">Categoria:</i>
          <input class="form-control"  REQUIRED name="categoria" type="text" value="<?php echo $row['categoria'];?>" class="validate" id="nombre">
        </div>
        <br>
      </div>
      ...
      <div class="row">
        <div class="input-field col s6">
          ...
          <input class="form-control" REQUIRED name="descripcion" type="text"value="<?php echo $row['descripcion'];?>" class="validate" id="telefono">
        </div>
      </div>
