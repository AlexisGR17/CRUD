...
?>
  ...
  <div class="row">
    <form class="col s12" method="POST" action="modificarserv.php?id_serv=<?php echo $row['id_serv']; ?>"method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">Nombre del servicio:</i>
          <input class="form-control"  REQUIRED name="nom_serv" type="text" value="<?php echo $row['nom_serv'];?>" class="validate" id="nom_serv">
        </div>
        <br>
      </div>
      ...
      <div class="row">
       ...
       <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">Provedor </i>
          <input class="form-control" REQUIRED name="provedor" type="text"value="<?php echo $row['provedor'];?>" class="validate" id="provedor">
        </div>
      </div>
      <div class="row">
        <div class="input-field col s6">
