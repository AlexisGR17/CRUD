...
<tr>
<td><?php echo $row['id_remitente']; ?></td>
<td><?php echo $row['nombre']; ?></td>
<td><?php echo $row['telefono']; ?></td>
<td><?php echo $row['codigo_postal']; ?></td>
<td><?php echo $row['calle_avenida']; ?></td>
<td><?php echo $row['municipio']; ?></td>

<td>
   <a type="submit" class="btn btn-outline-secondary" href="formulario_modificaremitente.php?id_remitente=<?php echo $row['id_remitente'];?>">
    <img src="https://cdn5.dibujos.net/dibujos/pintados/201125/f2db30b527a16bfea022e7c6e9dcb93f.png"width="50px" height="50px">
    
  </a>
</td>
<td>
<a type="submit" class="btn btn-outline-danger" href="eliminaremitente.php?id_remitente=<?php echo $row['id_remitente'];?>">
...
?>
<a type="submit" class="btn btn-outline-danger" href="agregaremitente.html">
