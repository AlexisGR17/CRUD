...
?>
  ...
  <div class="row">
    <form class="col s12" method="POST" action="modificarprov.php?id_provedor=<?php echo $row['id_provedor'];?>"method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">Nombre Provedor :</i>
      ...
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">Telefono del provedor:</i>
      ...
      <div class="row">
        <div class="input-field col s6">
          ...
          <input class="form-control" REQUIRED name="producto" type="text" value="<?php echo $row['producto'];?>"class="validate" id="producto">
        </div>
      </div>
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">Cantidad </i>
          <input class="form-control" REQUIRED name="cantidad" type="text" value="<?php echo $row['cantidad'];?>"class="validate" id="cantidad">
        </div>
      </div>
      <div class="row">
        <div class="input-field col s6">
